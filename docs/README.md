...
Do not describe The Piece as a dividend. Do not offer studio equity. Quote creator fee cap is 300 bps in Author mode and 100 bps in OnceUponers mode. OnceUpon prints on Arc only.
