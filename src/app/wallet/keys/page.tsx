  ...
  return (
    <div className="space-y-6 pad-fade">
      <section className="rounded-3xl border border-amber-300/20 bg-amber-300/5 p-6 sm:p-8">
        ...
        <h1 className="mt-2 text-4xl font-semibold tracking-tight">Private keys</h1>
        <p className="mt-3 max-w-2xl text-white/60">
          This page can reveal secrets. Do not screenshot it. Do not share it. Use it only to back up or import a desk
          wallet.
        </p>
        <div className="mt-5">
